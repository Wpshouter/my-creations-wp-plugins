    ...
    <div class="the_content">
        ...
        <div class="form_div">
            <div class="input-grp">
                ...
                <input class="chager_plus_pro" id="name_1_love_two_svg" name="name_1" type="text" value="" reduce-size="35" reduce-font="4" maxlength="10" placeholder="Nina" />
                <span class="charCount">0/10</span>
            </div>
            <div class="input-grp">
                <label for="name_2">Meno 2</label>
                <input class="chager_plus_pro" id="name_2_love_two_svg" name="name_2" type="text" value="" reduce-size="35" reduce-font="4" maxlength="10" placeholder="Pavol" />
                <span class="charCount">0/10</span>
            </div>
            <div class="input-grp">
                <label for="b_text">Vypíšte venovanie</label>
                <input class="chager_plus_pro" id="b_text_love_two_svg" name="b_text" type="text" value="" reduce-font="10" maxlength="20" placeholder="Love you to the moon" />
                <span class="charCount">0/20</span>
            </div>
            <div class="input-grp svg_holder_c">
                <label for="">Náhľad</label>
                <div class="svg_holder">
                    <?php require(plugin_dir_path(__FILE__) . 'love-two-svg.php'); ?>
                </div>
            </div>
            <input type="hidden" name="shape_name" value="Love-Two" />
