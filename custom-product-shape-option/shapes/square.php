    ...
    <a href="#" id="cloe_mama">&#9747;</a>
        <div class="form_div">
            <div class="input-grp">
                ...
                <input class="chager_plus_pro" id="name_1_square_svg" name="name_1" value="" reduce-size="35" reduce-font="4" maxlength="10" type="text" value="" placeholder="Nina" />
                <span class="charCount">0/10</span>
            </div>
             <div class="input-grp">
                <label for="name_2">Meno 2</label>
                <input class="chager_plus_pro" id="name_2_square_svg" name="name_2" value="" reduce-size="35" reduce-font="4" maxlength="10" type="text" value="" placeholder="Pavol" />
                <span class="charCount">0/10</span>
            </div> 
            <div class="input-grp">
                <label for="b_text">Vypíšte venovanie</label>
                <input class="chager_plus_pro" id="b_text_square_svg" name="b_text" value="" reduce-size="35" reduce-font="4" maxlength="20" type="text" value="" placeholder="Love you to the moon" />
                <span class="charCount">0/20</span>
            </div>
            <div class="input-grp svg_holder_c">
                <label for="">Náhľad</label>
                <div class="svg_holder">
                    <?php   require(plugin_dir_path( __FILE__ ) . 'square-svg.php'); ?>
                </div>
            </div>
            <input type="hidden" name="shape_name" value="Square" />
        ...
        $(document).on('keyup', '.chager_plus_pro', function(){
            ...
            if(svg_text_ement.length > 0){
               ...
               if (value.length > reduce_font) {
                   ...
                   //holder_val = svg_text_ement.css('font-size');
                   ...
                   console.log(value.length);
                   if (value.length > 8) {
                            newFontSize = value.length * 14;
                        } else {
                            if (reduce_size == '') {
                                reduce_size = 35;
                            }
                            if(value.length == 5){
                                newFontSize = value.length * 55;
                            }
                            else if(value.length == 7 || value.length == 8){
                                newFontSize = value.length * 23;
                            }
                            else{
